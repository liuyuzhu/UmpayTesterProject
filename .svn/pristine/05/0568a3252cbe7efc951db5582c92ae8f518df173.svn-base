...
public class SpayRestQueryApi {
	static Logger log=Logger.getLogger(SpayRestQueryApi.class);  
	   public static  String result = ""	;

	public  static String query (SpayRestBean bean) {
		bean.setUrl(bean.queryUrl);
