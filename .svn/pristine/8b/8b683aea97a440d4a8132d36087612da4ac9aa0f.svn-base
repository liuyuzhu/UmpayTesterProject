...
//	static String token;
	static String token="18b9828a63b2e70acc261700dbf649a3c5e5e80cfaf7a0ed3c277713fc95145d";
//	static String token=GetToken.token;
...
//		
		...
		String refundQuryUrl = refundResult.substring(refundResult.indexOf("self\",\"method\":\"GET\",\"href\":\"")+29, refundResult.lastIndexOf("\"}],\"refund\"")).replaceAll(addressReturn, address);
