...
import com.umpaytester.spayrest.util.GetURL;

	public class Test_B2C_ServerToServer_Debitcard_First {
		
		public static void main(String[] args) {
			Test_B2C_ServerToServer_Debitcard_First test = new Test_B2C_ServerToServer_Debitcard_First();
...
//			 smsUrl = GetURL.getSmsUrl(responseString);
			return flag;
	}
