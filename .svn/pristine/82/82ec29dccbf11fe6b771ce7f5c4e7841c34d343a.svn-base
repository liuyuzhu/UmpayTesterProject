...
public class TestAgreementsOpen {
	static Logger log=Logger.getLogger(TestAgreementsOpen.class);  
...
//		m.put("batch", mm);
		...
		String openResMsg=CbewebRestBaseTest.httpPost(open,"70510002", "http://10.10.178.36:8071/cbeweb_rest/receipt/agreements/"+id+"/open");
