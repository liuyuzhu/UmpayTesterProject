...
public class cb_confirm_pay_shortcut {
//	public static void main(String[] args) {
//		cb_confirm_pay_shortcut test = new cb_confirm_pay_shortcut();
//		try {
//			test.Test_cb_confirm_pay_shortcut();
...
//	}
	...
	//	 说明interface_type=02时，pay_type= WECHAT、ALIPAY、 B2BBANK
		 ...
		 request.put("service","cb_apply_pay_shortcut");
