...
public class Test_B2C_ServerToWeb_NotApplicable_WithQrcodeScan {
	
	public static void main(String[] args) {
		Test_B2C_ServerToWeb_NotApplicable_WithQrcodeScan test = new Test_B2C_ServerToWeb_NotApplicable_WithQrcodeScan();
...
//--------------------创建Payer对象，配置具体的接口参数、风控字段、以及BaseTest中不存在的参数-----------------------------------------//
	    ...
	    //   payerInfo.setPhone("15210909812");
	       ...
	       qcs.setQrCodeUrl("http://www.baidu.com");
