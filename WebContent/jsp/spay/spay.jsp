...
<div class="div-left"  style="height: 590px;width: 550px;  font-size:10px; background: white; color: #aaa; padding: 10px;border:1px solid  #242424">
		...
		<td style="height: 20px;" valign="middle"><input  style="width: 150px; height: 100%;border:5px solid blue;padding:5px;background-color:transparent;" type="text" name="card_holder" id="card_holder" value="罗淳雅" /></td>
						</tr><tr>
		
		<td style="height: 20px;" valign="middle"> 收货人证件号</td>
		<td><input  style="width: 150px; height: 100%;border:5px solid blue;padding:5px;background-color:transparent;" type="text" name="identity_code" id="identity_code" value="431381198109106573" /></td>
		...
		<td><input style="width: 150px; height: 100%;border:5px solid blue;padding:5px;background-color:transparent;"  type="text" name="mobile_id" id="mobile_id" value="13131313131" /></td>
