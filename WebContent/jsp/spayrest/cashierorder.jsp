		...
		<form name="orderApi" method="post" action="/UmpayTesterProject/SpayRestOrderApiServlet">
			...
			<td  >环境选择<label style="color: red">*</label></td>
					...
					<div class = "payment_method">
					   <select    name="interface_type" id="interface_type" style="width: 45%; height: 100%;border:5px solid blue;padding:5px;background-color:transparent;">
			      	    <option  value="SERVER_TO_WEB" selected="selected">收银台下单</option>
			      	    <option  value="SERVER_TO_H5WEB" selected="selected">收银台H5下单</option>
					</select>
					</div></td>
			...
			<option value="NOK">挪威克朗</option>
				...
				<tr>
	<td style="height: 30px;" valign="middle">PaymentMethod</td><td><input style="width: 86%; height: 100%;border:5px solid blue;padding:5px;background-color:transparent;" type=text id="payment_method"  name="payment_method" value="NOT_APPLICABLE" /></td>
